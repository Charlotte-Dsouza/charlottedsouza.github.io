[README.md](https://github.com/user-attachments/files/31118928/README.md)
...
**Adding a playbook, framework or analysis.** Copy a `<div class="art">` block in the Playbooks section. Three per row on desktop, so add in threes if you want a tidy grid. There are eight cards now, so the last row holds two.
